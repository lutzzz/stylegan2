...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='dctfs5k',   func_name='metrics.dct_fake_score.DCTFS',           num_images=5000, minibatch_per_gpu=8),
    EasyDict(name='dctfs1k',   func_name='metrics.dct_fake_score.DCTFS',           num_images=1000, minibatch_per_gpu=8),
]])
